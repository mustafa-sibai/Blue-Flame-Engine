	...
	namespace Platform
	{
		namespace API
		{
			namespace OpenGL
			{
				...
				void GLConstentBuffer::Create(void *data, unsigned int size, const unsigned int bindingIndex)
				{
				...
				void GLConstentBuffer::Update(void *data, const unsigned int size)
				{
					glBindBuffer(GL_UNIFORM_BUFFER, buffer);
