			...
			namespace OpenGL
			{
				class BF_API GLTextureCube
				{
					...
					public:
						...
						void Create(std::vector<Graphics::API::Texture::TextureData>& textureData, Graphics::API::Texture::Format format, Graphics::API::Texture::TextureWrap textureWrap, Graphics::API::Texture::TextureFilter textureFilter);
						void Bind() const;
						void Unbind() const;
