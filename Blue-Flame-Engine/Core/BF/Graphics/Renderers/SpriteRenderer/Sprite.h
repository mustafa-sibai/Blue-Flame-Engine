		...
		namespace Renderers
		{
			...
			class BF_API Sprite : public Renderable
			{
				...
				public:
					...
					Sprite(const Graphics::API::Texture2D* texture2D, const BF::Math::Rectangle& rectangle, unsigned int zLayer, const BF::Math::Rectangle& scissorRectangle, const Color& color);
					~Sprite();
